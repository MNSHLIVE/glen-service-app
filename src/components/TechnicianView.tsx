...
const TechnicianView: React.FC<TechnicianViewProps> = ({ onViewTicket }) => {
  const { user, tickets, logout, technicians, fetchLatestData, isSyncing, lastSyncTime, markAttendance } = useAppContext();
  ...
  return (
    <div className="space-y-6 pb-16">
      <div className="bg-white p-4 rounded-lg shadow-md flex justify-between items-center">
        ...
        <div className="flex items-center space-x-2">
           <button onClick={() => fetchLatestData()} disabled={isSyncing} className="p-2 bg-blue-100 text-blue-600 rounded-full hover:bg-blue-200 transition-colors disabled:opacity-50" title="Fetch Latest Data">
