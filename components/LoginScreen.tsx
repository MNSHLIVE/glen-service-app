        ...
        {isCredentialMode ? (
            ...
            <form onSubmit={handleCredentialLogin} className="space-y-4">
                <div>
                    ...
                    <input type="text" value={username} onChange={e => setUsername(e.target.value)} className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-glen-blue focus:border-glen-blue" placeholder="e.g. admin" autoFocus />
                </div>
                <div>
