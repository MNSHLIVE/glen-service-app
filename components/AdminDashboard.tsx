...
const AdminDashboard: React.FC<{ onViewTicket: (id: string) => void }> = ({ onViewTicket }) => {
  const { user, logout, syncTickets, technicians, tickets, webhookStatus, checkWebhookHealth } = useAppContext();
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white p-5 rounded-2xl shadow-md border-t-4 border-indigo-500 space-y-4">
          <div className="flex justify-between items-center">
             ...
             <button onClick={() => syncTickets(false)} className="text-[10px] bg-indigo-50 text-indigo-600 px-3 py-1 rounded-full font-bold">Refresh Server Data</button>
          </div>
