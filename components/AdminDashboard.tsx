    ...
    <div className="space-y-6">
      <div className="bg-white p-4 rounded-lg shadow-md flex justify-between items-center">
        ...
        <div className="flex items-center space-x-2">
            <button onClick={() => syncTickets()} disabled={isSyncing} className="text-sm bg-blue-500 text-white font-semibold p-2 rounded-lg hover:bg-blue-600 transition-colors disabled:bg-gray-400">
